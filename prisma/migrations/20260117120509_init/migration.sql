...
-- CreateEnum
CREATE TYPE "TaskOrigin" AS ENUM ('USER', 'AGENT');
...
-- AddForeignKey
ALTER TABLE "Chunk" ADD CONSTRAINT "Chunk_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
